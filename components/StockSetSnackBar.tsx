...
interface StockSetSnackBarProps {
  buttonText: string;
  product: Product;
  newStock: number;
}
...
export default function StockSetSnackBar({ buttonText, product, newStock }: StockSetSnackBarProps) {
  ...
  const handleClick =
    ...
    fetch('/api/inventory/stock/update', {
        method: 'PATCH',
        headers: {
